...
def get_email(from_email: Optional[str] = None,
    ...
    default_breached_password = fusionauth.get_email(name="[FusionAuth Default] Breached Password Notification")
    ```
...
@_utilities.lift_output_func(get_email)
def get_email_output(from_email: Optional[pulumi.Input[Optional[str]]] = None,
