...
namespace theogravity.Fusionauth
{
    ...
    public partial class FusionAuthEntityGrant : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthEntityGrantArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// An object that can hold any information about the Grant that should be persisted. Please review the limits on data field types as you plan for and build your custom data schema.  Must be a JSON string.
        /// </summary>
    ...
    public sealed class FusionAuthEntityGrantState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// An object that can hold any information about the Grant that should be persisted. Please review the limits on data field types as you plan for and build your custom data schema.  Must be a JSON string.
        /// </summary>
