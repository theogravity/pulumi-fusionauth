...
namespace theogravity.Fusionauth
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sonyPsn = new Fusionauth.FusionAuthIdpPsn("sonyPsn", new Fusionauth.FusionAuthIdpPsnArgs
    ///         {
    ...
    public partial class FusionAuthIdpPsn : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthIdpPsnArgs : Pulumi.ResourceArgs
    {
    ...
    public sealed class FusionAuthIdpPsnState : Pulumi.ResourceArgs
    {
        [Input("applicationConfigurations")]
