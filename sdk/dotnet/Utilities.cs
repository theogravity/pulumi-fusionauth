...
namespace theogravity.Fusionauth
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/theogravity/pulumi-fusionauth/releases/download/${VERSION}";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("theogravity.Fusionauth.version.txt");
    ...
    internal sealed class FusionauthResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public FusionauthResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
