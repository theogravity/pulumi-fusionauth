...
namespace theogravity.Fusionauth
{
    ...
    ///     public MyStack()
    ///     {
    ///         var forum = new Fusionauth.FusionAuthApplication("forum", new Fusionauth.FusionAuthApplicationArgs
    ///         {
    ...
    public partial class FusionAuthApplication : Pulumi.CustomResource
    {
    ...
    public sealed class FusionAuthApplicationArgs : Pulumi.ResourceArgs
    {
    ...
    public sealed class FusionAuthApplicationState : Pulumi.ResourceArgs
    {
        [Input("accessControlConfiguration")]
