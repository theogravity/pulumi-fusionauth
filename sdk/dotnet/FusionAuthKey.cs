...
namespace theogravity.Fusionauth
{
    ...
    ///     public MyStack()
    ///     {
    ///         var adminId = new Fusionauth.FusionAuthKey("adminId", new Fusionauth.FusionAuthKeyArgs
    ///         {
    ///             Algorithm = "RS256",
    ///             Length = 2048,
    ///         });
    ...
    public partial class FusionAuthKey : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthKeyArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The algorithm used to encrypt the Key. The following values represent algorithms supported by FusionAuth:
        /// </summary>
    ...
    public sealed class FusionAuthKeyState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The algorithm used to encrypt the Key. The following values represent algorithms supported by FusionAuth:
        /// </summary>
