...
namespace theogravity.Fusionauth
{
    ...
    public partial class FusionAuthEntity : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthEntityArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OAuth 2.0 client ID. If you leave this blank on create, the value of the Entity ID will
        /// be used. Must be a UUID.
    ...
    public sealed class FusionAuthEntityState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OAuth 2.0 client ID. If you leave this blank on create, the value of the Entity ID will
        /// be used. Must be a UUID.
