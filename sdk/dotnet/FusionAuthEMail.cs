...
namespace theogravity.Fusionauth
{
    ...
    ///     public MyStack()
    ///     {
    ///         var helloWorld = new Fusionauth.FusionAuthEMail("helloWorld", new Fusionauth.FusionAuthEMailArgs
    ///         {
    ...
    public partial class FusionAuthEMail : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthEMailArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The default From Name used when sending emails. If not provided, and a localized value cannot be determined, the default value for the tenant will be used. This is the display name part of the email address ( i.e. Jared Dunn &lt;jared@piedpiper.com&gt;).
        /// </summary>
    ...
    public sealed class FusionAuthEMailState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The default From Name used when sending emails. If not provided, and a localized value cannot be determined, the default value for the tenant will be used. This is the display name part of the email address ( i.e. Jared Dunn &lt;jared@piedpiper.com&gt;).
        /// </summary>
