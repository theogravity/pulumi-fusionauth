...
namespace theogravity.Fusionauth
{
    ...
    ///     public MyStack()
    ///     {
    ///         var mytheme = new Fusionauth.FusionAuthTheme("mytheme", new Fusionauth.FusionAuthThemeArgs
    ///         {
    ///             AccountEdit = "[#ftl/]",
    ///             AccountIndex = "[#ftl/]",
    ...
    public partial class FusionAuthTheme : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthThemeArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A FreeMarker template that is rendered when the user requests the /account/edit path. This page contains a form that enables authenticated users to update their profile.
        /// </summary>
    ...
    public sealed class FusionAuthThemeState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A FreeMarker template that is rendered when the user requests the /account/edit path. This page contains a form that enables authenticated users to update their profile.
        /// </summary>
