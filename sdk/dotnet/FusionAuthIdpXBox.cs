...
namespace theogravity.Fusionauth
{
    ...
    ///     public MyStack()
    ///     {
    ///         var xbox = new Fusionauth.FusionAuthIdpXBox("xbox", new Fusionauth.FusionAuthIdpXBoxArgs
    ///         {
    ...
    public partial class FusionAuthIdpXBox : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthIdpXBoxArgs : Pulumi.ResourceArgs
    {
    ...
    public sealed class FusionAuthIdpXBoxState : Pulumi.ResourceArgs
    {
        [Input("applicationConfigurations")]
