...
namespace theogravity.Fusionauth
{
    ...
    /// ```
    /// </summary>
    [FusionauthResourceType("fusionauth:index/fusionAuthApplicationOAuthScope:FusionAuthApplicationOAuthScope")]
    public partial class FusionAuthApplicationOAuthScope : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a FusionAuthApplicationOAuthScope resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public FusionAuthApplicationOAuthScope(string name, FusionAuthApplicationOAuthScopeArgs args, CustomResourceOptions? options = null)
            : base("fusionauth:index/fusionAuthApplicationOAuthScope:FusionAuthApplicationOAuthScope", name, args ?? new FusionAuthApplicationOAuthScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FusionAuthApplicationOAuthScope(string name, Input<string> id, FusionAuthApplicationOAuthScopeState? state = null, CustomResourceOptions? options = null)
            : base("fusionauth:index/fusionAuthApplicationOAuthScope:FusionAuthApplicationOAuthScope", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "fusionauth:index/applicationOauthScope:ApplicationOauthScope" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FusionAuthApplicationOAuthScope Get(string name, Input<string> id, FusionAuthApplicationOAuthScopeState? state = null, CustomResourceOptions? options = null)
        {
            return new FusionAuthApplicationOAuthScope(name, id, state, options);
        }
    }

    public sealed class FusionAuthApplicationOAuthScopeArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// ID of the application that this role is for.
        /// </summary>
        ...
        public FusionAuthApplicationOAuthScopeArgs()
        {
        }
        public static new FusionAuthApplicationOAuthScopeArgs Empty => new FusionAuthApplicationOAuthScopeArgs();
    }

    public sealed class FusionAuthApplicationOAuthScopeState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// ID of the application that this role is for.
        /// </summary>
        ...
        public FusionAuthApplicationOAuthScopeState()
        {
        }
        public static new FusionAuthApplicationOAuthScopeState Empty => new FusionAuthApplicationOAuthScopeState();
    }
}
