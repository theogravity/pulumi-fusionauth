...
namespace theogravity.Fusionauth
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apple = new Fusionauth.FusionAuthIdpApple("apple", new Fusionauth.FusionAuthIdpAppleArgs
    ///         {
    ...
    public partial class FusionAuthIdpApple : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthIdpAppleArgs : Pulumi.ResourceArgs
    {
    ...
    public sealed class FusionAuthIdpAppleState : Pulumi.ResourceArgs
    {
        [Input("applicationConfigurations")]
