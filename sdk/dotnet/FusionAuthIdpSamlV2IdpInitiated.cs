...
namespace theogravity.Fusionauth
{
    ...
    public partial class FusionAuthIdpSamlV2IdpInitiated : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthIdpSamlV2IdpInitiatedArgs : Pulumi.ResourceArgs
    {
    ...
    public sealed class FusionAuthIdpSamlV2IdpInitiatedState : Pulumi.ResourceArgs
    {
        [Input("applicationConfigurations")]
