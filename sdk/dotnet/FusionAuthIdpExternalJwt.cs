...
namespace theogravity.Fusionauth
{
    ...
    ///     public MyStack()
    ///     {
    ///         var jwt = new Fusionauth.FusionAuthIdpExternalJwt("jwt", new Fusionauth.FusionAuthIdpExternalJwtArgs
    ///         {
    ///             ClaimMap = 
    ///             {
    ...
    public partial class FusionAuthIdpExternalJwt : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthIdpExternalJwtArgs : Pulumi.ResourceArgs
    {
    ...
    public sealed class FusionAuthIdpExternalJwtState : Pulumi.ResourceArgs
    {
        [Input("applicationConfigurations")]
