...
namespace theogravity.Fusionauth
{
    ...
    ///     public MyStack()
    ///     {
    ///         var google = new Fusionauth.FusionAuthIdpGoogle("google", new Fusionauth.FusionAuthIdpGoogleArgs
    ///         {
    ...
    public partial class FusionAuthIdpGoogle : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthIdpGoogleArgs : Pulumi.ResourceArgs
    {
    ...
    public sealed class FusionAuthIdpGoogleState : Pulumi.ResourceArgs
    {
        [Input("applicationConfigurations")]
