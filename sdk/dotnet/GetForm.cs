...
namespace theogravity.Fusionauth
{
    public static class GetForm
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var @default = Output.Create(Fusionauth.GetForm.InvokeAsync(new Fusionauth.GetFormArgs
        ///         {
    ...
    public sealed class GetFormArgs : Pulumi.InvokeArgs
    {
        [Input("data")]
    ...
    public sealed class GetFormInvokeArgs : Pulumi.InvokeArgs
    {
        [Input("data")]
