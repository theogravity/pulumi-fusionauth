...
namespace theogravity.Fusionauth
{
    ...
    ///     public MyStack()
    ///     {
    ///         var twitch = new Fusionauth.FusionAuthIdpTwitch("twitch", new Fusionauth.FusionAuthIdpTwitchArgs
    ///         {
    ...
    public partial class FusionAuthIdpTwitch : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthIdpTwitchArgs : Pulumi.ResourceArgs
    {
    ...
    public sealed class FusionAuthIdpTwitchState : Pulumi.ResourceArgs
    {
        [Input("applicationConfigurations")]
