...
namespace theogravity.Fusionauth
{
    ...
    ///     public MyStack()
    ///     {
    ///         var reactor = new Fusionauth.FusionAuthReactor("reactor", new Fusionauth.FusionAuthReactorArgs
    ///         {
    ///             License = "abc",
    ///             LicenseId = "xyz",
    ///         });
    ...
    public partial class FusionAuthReactor : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthReactorArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The Base64 encoded license value. This value is necessary in an air gapped configuration where outbound network access is not available.
        /// </summary>
    ...
    public sealed class FusionAuthReactorState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The Base64 encoded license value. This value is necessary in an air gapped configuration where outbound network access is not available.
        /// </summary>
