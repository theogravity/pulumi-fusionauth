...
namespace theogravity.Fusionauth
{
    ...
    ///     public MyStack()
    ///     {
    ///         var name = new Fusionauth.FusionAuthImportedKey("name", new Fusionauth.FusionAuthImportedKeyArgs
    ///         {
    ///             Kid = "8675309",
    ...
    public partial class FusionAuthImportedKey : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthImportedKeyArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The algorithm used to encrypt the Key. The following values represent algorithms supported by FusionAuth:
        /// </summary>
    ...
    public sealed class FusionAuthImportedKeyState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The algorithm used to encrypt the Key. The following values represent algorithms supported by FusionAuth:
        /// </summary>
