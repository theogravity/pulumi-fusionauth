...
namespace theogravity.Fusionauth
{
    ...
    ///     public MyStack()
    ///     {
    ///         var example = new Fusionauth.FusionAuthGenericConnector("example", new Fusionauth.FusionAuthGenericConnectorArgs
    ///         {
    ...
    public partial class FusionAuthGenericConnector : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class FusionAuthGenericConnectorArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The fully qualified URL used to send an HTTP request to authenticate the user.
        /// </summary>
    ...
    public sealed class FusionAuthGenericConnectorState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The fully qualified URL used to send an HTTP request to authenticate the user.
        /// </summary>
