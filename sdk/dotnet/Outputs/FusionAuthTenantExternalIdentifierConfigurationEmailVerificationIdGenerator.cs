...
namespace theogravity.Fusionauth.Outputs
{
    ...
    [OutputType]
    public sealed class FusionAuthTenantExternalIdentifierConfigurationEmailVerificationIdGenerator
    {
        /// <summary>
        ...
        [OutputConstructor]
        private FusionAuthTenantExternalIdentifierConfigurationEmailVerificationIdGenerator(
            int? length,
