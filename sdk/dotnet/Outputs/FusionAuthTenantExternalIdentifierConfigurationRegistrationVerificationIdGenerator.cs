...
namespace theogravity.Fusionauth.Outputs
{
    ...
    [OutputType]
    public sealed class FusionAuthTenantExternalIdentifierConfigurationRegistrationVerificationIdGenerator
    {
        /// <summary>
        ...
        [OutputConstructor]
        private FusionAuthTenantExternalIdentifierConfigurationRegistrationVerificationIdGenerator(
            int length,
