...
namespace theogravity.Fusionauth.Outputs
{
    ...
    [OutputType]
    public sealed class FusionAuthTenantExternalIdentifierConfigurationPasswordlessLoginGenerator
    {
        /// <summary>
        ...
        [OutputConstructor]
        private FusionAuthTenantExternalIdentifierConfigurationPasswordlessLoginGenerator(
            int length,
