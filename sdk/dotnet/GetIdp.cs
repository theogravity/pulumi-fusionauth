...
namespace theogravity.Fusionauth
{
    public static class GetIdp
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var fusionAuth = Output.Create(Fusionauth.GetIdp.InvokeAsync(new Fusionauth.GetIdpArgs
        ///         {
        ///             Name = "Apple",
        ///             Type = "Apple",
        ///         }));
    ...
    public sealed class GetIdpArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    public sealed class GetIdpInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// The name of the identity provider. This is only used for display purposes. Will be the type for types: `Apple`, `Facebook`, `Google`, `HYPR`, `Twitter`
        /// </summary>
