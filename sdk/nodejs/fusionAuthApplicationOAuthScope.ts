 ...
 * ```
 */
export class FusionAuthApplicationOAuthScope extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FusionAuthApplicationOAuthScopeState, opts?: pulumi.CustomResourceOptions): FusionAuthApplicationOAuthScope {
        return new FusionAuthApplicationOAuthScope(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fusionauth:index/fusionAuthApplicationOAuthScope:FusionAuthApplicationOAuthScope';

    /**
     * Returns true if the given object is an instance of FusionAuthApplicationOAuthScope.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FusionAuthApplicationOAuthScope {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FusionAuthApplicationOAuthScope.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: FusionAuthApplicationOAuthScopeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FusionAuthApplicationOAuthScopeArgs | FusionAuthApplicationOAuthScopeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FusionAuthApplicationOAuthScopeState | undefined;
            ...
            const args = argsOrState as FusionAuthApplicationOAuthScopeArgs | undefined;
 ...
 */
export interface FusionAuthApplicationOAuthScopeState {
    /**
     * ID of the application that this role is for.
     */
