 ...
 * ```
 */
export class FusionAuthIdpSteam extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FusionAuthIdpSteamState, opts?: pulumi.CustomResourceOptions): FusionAuthIdpSteam {
        return new FusionAuthIdpSteam(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fusionauth:index/fusionAuthIdpSteam:FusionAuthIdpSteam';

    /**
     * Returns true if the given object is an instance of FusionAuthIdpSteam.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FusionAuthIdpSteam {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FusionAuthIdpSteam.__pulumiType;
    }
     ...
     */
    public readonly tenantConfigurations!: pulumi.Output<outputs.FusionAuthIdpSteamTenantConfiguration[] | undefined>;
    /**
     ...
     */
    public readonly webApiKey!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: FusionAuthIdpSteamArgs | FusionAuthIdpSteamState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["webApiKey"] = state ? state.webApiKey : undefined;
        } else {
            const args = argsOrState as FusionAuthIdpSteamArgs | undefined;
            ...
            resourceInputs["webApiKey"] = args ? args.webApiKey : undefined;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(FusionAuthIdpSteam.__pulumiType, name, resourceInputs, opts);
    }
}
