module github.com/theogravity/pulumi-fusionauth/provider
...
require (
	github.com/FusionAuth/terraform-provider-fusionauth v0.2.0
...
require (
	...
	github.com/FusionAuth/go-client v0.0.0-20241221155813-3c38fd514d84 // indirect
